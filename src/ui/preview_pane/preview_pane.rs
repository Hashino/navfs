            ...
            match self.curr_entry.extension() {
                Some(extension) => match extension.to_str() {
                    Some("png") | Some("jpg") | Some("jpeg") => {
                        get_image_ascii_paragraph(area, buf, self.curr_entry.clone());
                    }
                    _ => {
...
// TODO: find a library to convert images to ASCII
fn get_image_ascii_paragraph(area: Rect, buf: &mut Buffer, image_file: PathBuf) {
